...
namespace PandoraEX
{
    ...
    public:
        ...
        ReturnType invoke(Args &&...args)
        {
            ...
            // ThrowExceptionF(Exceptions::SignatureException, "%s", Exceptions::SignatureException(__signature, __FILE__, __LINE__, args...).what());
            Exceptions::SignatureException(__signature, __FILE__, __LINE__, args...).throw_();
