...
template struct PandoraEX::Base2D::Base2D<PandoraEX::Position2>;
...
template struct PandoraEX::Base2D::Math<PandoraEX::Position2>;


// template struct PandoraEX::Base2D::Transform<PandoraEX::Vector2>;
template struct PandoraEX::Base2D::Transform<PandoraEX::Size2>;
template struct PandoraEX::Base2D::Transform<PandoraEX::Position2>;
...
template struct PandoraEX::Base2D::Point2D<PandoraEX::Position2>;
