...
#define Exception_(exceptionClass, __format, ...) PandoraEX::Exceptions::Exception(PandoraEX::String::format(__format, ##__VA_ARGS__), PandoraEX::Utils::demangle(typeid(exceptionClass).name()), PandoraEX::String(__FILE__), std::to_string(__LINE__))
...
#define ExceptionF_(exceptionClass, __format, ...) PandoraEX::Exceptions::Exception(PandoraEX::String::format(__format, ##__VA_ARGS__), PandoraEX::Utils::demangle(typeid(exceptionClass).name()), PandoraEX::String(__FILE__), std::to_string(__LINE__), __func__)
...
#define ThrowExceptionF(exceptionClass, format, ...) {PandoraEX::Exceptions::Exception ex = ExceptionF_(exceptionClass, format, ##__VA_ARGS__); ex.log(true); throw ex;}
    ...
    Class(SignatureException) pextends Exception
    {
    public:
    ...
    Class(ArgumentCountException) pextends Exception
    {
    public:
    ...
    Class(NullReferenceException) pextends Exception
    {
    public:
    ...
    Class(NotFoundException) pextends Exception
    {
    public:
    ...
    Class(IndexOutOfBoundsException) pextends Exception
    {
    public:
    ...
    Class(NotImplementedException) pextends Exception
    {
    public:
        NotImplementedException(String message = "This feature is not implemented yet.") noexcept : Exception(message) {}
        NotImplementedException(String message, String file, String line) noexcept : Exception(message, "NotImplementedException", file, line) {}
