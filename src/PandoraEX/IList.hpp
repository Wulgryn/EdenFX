...
namespace PandoraEX
{
    ...
    public:
        ...
        virtual std::conditional_t<std::is_pointer_v<T>, T, const T &> at(std::size_t index) const = 0;

        /// @brief Gets an item at a specific index from the list.
        /// @param index The index of the item to get.
        /// @return The item at the specified index.
        virtual std::conditional_t<std::is_pointer_v<T>, T, const T &> operator[](std::size_t index) const = 0;
        ...
        /// @brief Replaces an item at a specific index in the list.
        /// @param index The index of the item to replace.
        /// @param item The new item to set at the specified index.
        virtual void replaceAt(std::size_t index, const T &item) = 0;
