...
DWORD WINAPI RemoteLoadLibrary(LPVOID param) {
    // betölti a DLL-t, param LPCSTR cím
    HINSTANCE h = LoadLibraryA(reinterpret_cast<LPCSTR>(param));
    return (DWORD)(uintptr_t)h;  // visszaadhatod a HINSTANCE-t, ha kell
}
...
void DebugConsole::mf_attach()
{
    ...
    logInfo("Debug console reattached successfully.\0");
}