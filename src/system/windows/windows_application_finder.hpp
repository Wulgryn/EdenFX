#ifndef EDEN_SYSTEM_WINDOWS_APPLICATION_FINDER_HPP
#define EDEN_SYSTEM_WINDOWS_APPLICATION_FINDER_HPP

#include "system/i_application_finder.hpp"

namespace Eden::System
{
    class WindowsApplicationFinder : public IApplicationFinder
    {
    public:
...
#endif // EDEN_SYSTEM_WINDOWS_APPLICATION_FINDER_HPP
